...
### We will compute the data on separate graphs because Date is difficult to adjust.

```{r, include= FALSE}
library(dplyr)
library(ggplot2)
ggplot(BikeWashingtonAndSeoul, aes(x = Date, y = Temperature, col = as.factor(Season)))+
  geom_point() +
  labs(x = "Time in days", y = "Air Temperature", col = "Seasons") +
  facet_wrap(~Location)

ggplot(BikeSeoul, aes(x = Date, y = Temperature, col = as.factor(Season)))+
  geom_point() +
  labs(title = "Seoul Air Temperature over Time", x = "Time in days", y = "Air Temperature", col = "Seasons")

ggplot(BikeWashington, aes(x = Date, y = Temperature, col = as.factor(Season)))+
  geom_point() +
  labs(x = "Time in days", y = "Air Temperature", col = "Seasons")
